    ...
    <div className="mb-8 bg-white min-h-screen mx-auto">
      <div className="py-10 px-4 sm:px-8 lg:px-16 mt-[6rem]">
        <div className="max-w-7xl mx-auto p-8">
          <h1 className="text-2xl font-bold text-left mb-6">Terms &amp; Conditions</h1>
          ...
          {[
            `&quot;We/Us&quot; means ULKA TV, City Online Media Pvt Ltd, Corporate office at 709, 7 th Floor, Aditya Trade Center, Ameerpet, Hyderabad, Telangana 500038, India and &quot;Our&quot; shall be interpreted accordingly.`,
          ...
          <p className="text-gray-700 mb-6">
            If any provision of the terms and condition shall be held unlawful, void or for any reason unenforceable, then that provision shall be deemed severable from these terms and conditions and shall not affect the validity and enforceability of the remaining provisions.
          </p>

          <h2 className="text-xl font-semibold mb-4">Registrations and Acceptance of Terms and Conditions and Your Obligation</h2>
          <p className="text-gray-700 mb-6">
          ...
          <h2 className="text-xl font-semibold mb-4">Offer Packs</h2>
          <p className="text-gray-700 mb-6">
            1.All Offer packs are for limited period only and ULKA TV reserves the rights to change/ revise the prices, alter the packs and composition of packs, subject to change in regulation/broadcaster price.
          </p>
          <p className="text-gray-700 mb-6">
            2.ULKA TV Partners may charge additional NCF from end customer, according to the market conditions.
          </p>
          <p className="text-gray-700 mb-6">
            3.Once customer is activated in the scheme, it cannot be cancelled, refunded, tranferred or cut short on the tenure.
          </p>

          <h2 className="text-xl font-semibold mb-4">Set-Top-Box</h2>
          <p className="text-gray-700 mb-6">
            1.ULKA TV is not responsible for issues arising out of bandwidth, network related blackouts and in this scenario pack cannot be extended/provide any grace period for the pack. It strictly expires by the period. ULKA TV Partners should take care of such issues independently.
          </p>
          <p className="text-gray-700 mb-6">
            2.In case of stb failures in the event of power surges/stb tampering, the consumer is liable to buy the stb to continue till end of scheme period.
          </p>
          <p className="text-gray-700 mb-6">
            3.In case of stb malfunctions due to manufacturing defect, the stb&apos;s will be replaced on FOC basis, however, it will be scrutinized by ULKA TV team and stb vendor to pass on the warranty credit, meanwhile distributor can pass on the standby/demo STB to customer.
          </p>
          <p className="text-gray-700 mb-6">
            4.All other general terms &amp; conditions shall be applicable.
          </p>
        </div>
      </div>
    </div>
