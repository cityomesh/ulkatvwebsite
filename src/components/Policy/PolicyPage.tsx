...
const PolicyPage: React.FC = () => {
  return (
    <div className="mb-8 bg-white min-h-screen mx-auto">
        <div className="py-10 px-4 sm:px-8 lg:px-16 mt-[4rem]">
          <div className="max-w-7xl mx-auto p-8">
            ...
            <motion.span
                className="text-blue-500 mr-2" // Change this to your desired color for the dash
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
            ...
            <motion.span
                className="text-gray-700" // This keeps the text color the same as before
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
            ...
            <p className="text-gray-700 mb-6">
            If you have any questions or suggestions about my Privacy Policy, do not hesitate contact us at privacy@ulka.tv.
            </p>
          </div>
        </div>
    </div>
