...
//   const [selectedLanguage, setSelectedLanguage] = useState<"All" | "Telugu">("All");
...
//   const teluguChannelMap: Record<string, string[]> = {
//     Entertainment: [
//       "ETV", "Zee Telugu", "Star Maa", "Gemini Hd", "Etv Plus", "ETv", "Star Ma",
//       "Gemeni", "Studio", "Yova", "Maha"
//     ],
//     News: [
//       "AndhraPradesh", "Telangana", "Tv News", "NTV", "Sakshi", "ABN", "TV9",
//       "T news", "HMTV", "Zee Telugu"
//     ],
//     Movies: ["StarMaa Now", "ETV CINEMA", "GEMINI MOVIES", "ZEE CINEMA"],
//     Kids: ["ETV BAL BHARAT", "POGO", "KUSHI TV"],
//     Music: ["GEMINI MUSIC HD", "MAA MUSIC", "GEMINI MUSIC", "RAJ"],
//     Lifestyle: ["GEMINI LIFE", "ETV ABHIRUCHI"],
//     Spiritual: ["Bhakti TV"],
//     Sports: ["STAR SPORTS", "SONY SPORTS 4", "Bhakti TV"],
//     Comedy: ["GEMINI COMEDY"],
//   };
...
//   const filteredBouqueData = bouqueData.filter((item) => {
//     const isTypeMatch =
//       item.type_lbl.toLowerCase().replace(/\s+/g, "") === selectedType.toLowerCase().replace(/\s+/g, "");
//     const isSearchMatch = item.name.toLowerCase().includes(searchQuery.toLowerCase());
  
//     if (selectedLanguage === "Telugu" && selectedType === "Alacarte") {
//       const allowedNames = teluguChannelMap[selectedCategory] || [];
//       return isTypeMatch && isSearchMatch && allowedNames.includes(item.name);
//     }
  
//     if (selectedLanguage === "Telugu" && selectedType !== "Alacarte") {
//       // Telugu packs lo display cheyyakudadu
//       return false;
//     }
  
//     // Default case (All languages)
...
//       {/* Language selection - if you want to support more in the future */}
...
//             setSelectedCategory("");
//           }}
//           className={`px-4 py-2 rounded-md font-medium ${selectedLanguage === "All" ? "bg-black text-white" : "bg-gray-300"}`}
//         >
//           All Languages
//         </button>
//         <button
...
//               // Already selected, so unselect Telugu
//               setSelectedLanguage("All");
//               setSelectedCategory("");
//             } else {
//               // Telugu select cheyyadam
//               setSelectedLanguage("Telugu");
//               setSelectedCategory("Entertainment");
//             }
//           }}
//           className={`px-4 py-2 rounded-md font-medium ${
//             selectedLanguage === "Telugu" ? "bg-black text-white" : "bg-gray-300"
//           }`}
//         >
//           Telugu
//         </button>
...
//             {/* Category Select (only if Telugu selected) */}
//             {selectedLanguage === "Telugu" && (
//               <div className="w-full grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-1 gap-2 p-2">
//                 {teluguCategories.map((category) => (
//                   <div
//                     key={category}
//                     onClick={() => setSelectedCategory(category)}
//                     className={`cursor-pointer border border-gray-500 rounded-md px-3 py-2 text-center text-sm font-medium ${
//                       selectedCategory === category ? "bg-gray-500 text-white" : "bg-white text-gray-700"
//                     }`}
//                   >
//                     {category}
//                   </div>
