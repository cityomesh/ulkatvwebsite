  ...
  return (
    <div className="mb-8 min-h-screen mx-auto">
      ...
      <div className="relative h-auto min-h-[95vh] bg-gradient-to-r from-[#FF4E55] to-[#FC913A] flex flex-col items-center justify-center px-4 py-10 overflow-hidden z-0 pt-32">
        <div className="absolute inset-0 bg-[radial-gradient(circle,_black_1px,transparent_1px)] [background-size:20px_20px] opacity-40 pointer-events-none z-0 mask-[radial-gradient(circle_at_center,transparent_60%,black_100%)]"></div>
        ...
        <div className="relative z-10 grid grid-cols-1 md:grid-cols-2 gap-8 items-center max-w-7xl w-full px-2 sm:px-6">
          <div className="text-center md:text-left flex flex-col items-center md:items-start">
            <p className="text-lg sm:text-2xl md:text-4xl text-black font-extrabold leading-normal sm:leading-snug mt-10 mb-4 sm:mb-6">
            ...
            <h3 className="text-black text-sm sm:text-base md:text-2xl font-extrabold my-3 sm:my-4 max-w-lg leading-relaxed">
              ...
              <button
                className="relative mt-4 px-4 py-2 sm:px-6 sm:py-2 md:px-8 md:py-3 rounded-xl bg-white/10 backdrop-blur-md border border-white/20 text-black font-bold text-sm sm:text-base md:text-lg shadow-lg hover:bg-gradient-to-r hover:from-red-600 hover:to-gray-700 hover:text-white transition-all duration-500 overflow-hidden group"
              >
            ...
            <div className="mt-6 grid grid-cols-2 gap-3 sm:grid-cols-4 w-full">
              <Link href="/smarttv" className="px-3 py-2 bg-black text-white font-bold rounded-lg hover:bg-white hover:text-black transition-all text-sm sm:text-lg text-center">Smart TV</Link>
              <Link href="/smartmobile" className="px-3 py-2 bg-black text-white font-bold rounded-lg hover:bg-white hover:text-black transition-all text-sm sm:text-lg text-center">Smart Mobile</Link>
              <Link href="/stb" className="px-3 py-2 bg-black text-white font-bold rounded-lg hover:bg-white hover:text-black transition-all text-sm sm:text-lg text-center">STB</Link>
              <Link href="/stick" className="px-3 py-2 bg-black text-white font-bold rounded-lg hover:bg-white hover:text-black transition-all text-sm sm:text-lg text-center">Stick</Link>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-wrap lg:flex-nowrap items-center lg:space-x-16 space-y-12 lg:space-y-0">
            <div className="w-full relative">
              <div className="w-full lg:w-[52rem] lg:h-[34rem] bg-cover transition-all duration-300 ease-in-out transform hover:scale-110 hover:translate-x-2 hover:translate-y-2">
                <div className="w-full flex justify-center">
                  <div className="w-full max-w-xs sm:max-w-md md:max-w-2xl lg:max-w-6xl aspect-w-16 aspect-h-9 transition-all duration-300 ease-in-out transform hover:scale-105 overflow-hidden border-[10px] sm:border-[15px] border-gray-400 rounded-lg shadow-xl">
                    <video className="w-full h-full object-cover" src="/intro.mp4" autoPlay loop muted />
                  </div>
                </div>
              </div>

              <div className="absolute top-0 right-0 w-[10rem] sm:w-[16rem] h-[15rem] sm:h-[25rem] bg-cover mt-[10rem] sm:mt-[12rem] transition-all duration-300 ease-in-out transform hover:scale-110 hover:translate-x-2 hover:translate-y-2 mb-8"
                   style={{ backgroundImage: "url('/nm.png')" }}></div>
            </div>
            ...
            <div className="w-full lg:w-1/2 text-center lg:text-left">
              ...
              <div className="flex justify-center lg:justify-start">
                <a href="https://play.google.com/store/apps/details?id=com.ulkatv.ulka"
                   target="_blank"
      ...
      <div className="bg-red-600 text-white flex flex-col md:flex-row items-center mt-[8rem] relative mb-8">
        ...
        <div className="w-full flex justify-center md:absolute md:top-0 md:right-0 md:w-auto mb-8">
          <Image src="/mainulkaimage.png" alt="Ulka TV" width={800} height={900} className="w-full md:w-auto object-cover" />
        </div>
      </div>
        ...
        <div className="flex justify-center items-center overflow-hidden xl:max-w-[1160px] max-w-full mb-8 space-x-4 sm:space-x-8 lg:space-x-16">
          <div className="flex space-x-4 sm:space-x-8 lg:space-x-16 animate-loop-scroll">
            {staticImages.map((image, index) => (
              <Image key={index} src={image.src} alt={image.alt} height={128} width={200} className="h-[40px] sm:h-[60px] md:h-[80px] lg:h-[100px] xl:h-[128px] w-auto cursor-pointer max-w-none object-contain" />
            ))}
          </div>
          <div className="flex space-x-4 sm:space-x-8 lg:space-x-16 animate-loop-scroll">
            {staticImages.map((image, index) => (
